...
const PrivacyPolicy = () => {
  useSeoMetadata({
    title: 'Privacy Policy | Noeis',
    description: 'Read the current privacy policy for Noeis, the concept-centered thinking workspace for serious readers.',
  ...
  return (
    <div className="legal-shell">
      <Card className="legal-card">
        ...
        <p>
          Noeis stores the information you choose to add so you can capture, organize, search, and revisit your
