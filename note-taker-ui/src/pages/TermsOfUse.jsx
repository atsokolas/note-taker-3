...
const TermsOfUse = () => (
  <div className="legal-shell">
    <Card className="legal-card">
      ...
      <p>
        These terms govern access to and use of Note Taker. This page is a product-facing terms starter and should be
    ...
    <Card className="legal-card">
      ...
      <p>You may use Note Taker to capture, import, organize, search, and revisit your own reading, notes, and related material.</p>
