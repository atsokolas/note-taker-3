...
describe('HandoffCreateForm', () => {
  it('shows setup-agent callout when specialist-agent routing is selected with no active agents', () => {
    render(
      <MemoryRouter>
        <HandoffCreateForm
          mode="integrations"
    ...
    expect(screen.getByText(/No active specialist agents yet\./)).toBeInTheDocument();
