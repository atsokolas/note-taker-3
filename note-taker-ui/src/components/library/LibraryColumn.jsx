...
const DEDICATED = {
  ...
  later: {
    eyebrow: 'Later',
    empty: 'Nothing in Later. Open a source and press Later when it still wants a move, just not now.',
    fallback: 'Waiting in Later, oldest first.',
    line: laterPileLine,
  ...
  'set-aside': {
    eyebrow: 'Set aside',
    empty: 'Nothing in Set aside. Open a source and press Set aside when you want it close this week.',
    fallback: 'Set aside for this week, newest on top.',
