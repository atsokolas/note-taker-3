...
const ArticleList = () => {
    ...
    const fetchAndGroupArticles = useCallback(async () => {
        ...
        setError(null);
        try {
            // --- FIX: Add withCredentials to both API calls ---
            ...
            setError("Failed to load articles or folders. You may need to log in again.");
        } finally {
            setLoading(false);
        }
    }, []);
    ...
    const handleCreateFolder = async () => {
        ...
        try {
            // --- FIX: Add withCredentials to the API call ---
    ...
    return (
        <div className="article-list-container"> {/* It's good practice to wrap components in a container div */}
